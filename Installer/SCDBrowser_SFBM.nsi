...
; 安装程序初始定义常量
!define PRODUCT_NAME "SCDBrowser-图档版"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "SCDBrowser_SFBM"
...
; 安装完成页面
!define MUI_FINISHPAGE_RUN "$INSTDIR\Release\SCDBrowser_SFBM.exe"
...
OutFile "SCDBrowser_SFBM(V${PRODUCT_VERSION}).exe"
InstallDir "$PROGRAMFILES\SCDBrowser_SFBM"
...
Section "MainSection" SEC01
  ...
  File "..\Release\SCDBrowser_SFBM.exe"
...
; 创建开始菜单快捷方式
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\SCDBrowser_SFBM.lnk" "$INSTDIR\Release\SCDBrowser_SFBM.exe"
  CreateShortCut "$DESKTOP\SCDBrowser_SFBM.lnk" "$INSTDIR\Release\SCDBrowser_SFBM.exe"
  CreateShortCut "$STARTMENU.lnk" "$INSTDIR\Release\SCDBrowser_SFBM.exe"*/
...
Section -Post
  ...
  WriteRegStr HKCR "SCDBrower\shell\open\command" "" '"$INSTDIR\Release\SCDBrowser_SFBM.exe" "%1"'
...
Section Uninstall
  ...
  Delete "$INSTDIR\Release\SCDBrowser_SFBM.exe"
...
/*  Delete "$SMPROGRAMS\$ICONS_GROUP\Uninstall.lnk"
  ...
  Delete "$DESKTOP\SCDBrowser_SFBM.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\SCDBrowser_SFBM.lnk" */
